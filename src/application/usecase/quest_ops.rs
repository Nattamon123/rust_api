use crate::domain::{repo::{quest_ops::QuestOpsRepository, quest_viewing::QuestViewingRepository}, value_object::quest_model::{AddQuestModel, EditQuestModel}};
use std::sync::Arc;
use anyhow::Result;
...

{
    ...
    pub async fn edit(&self, quest_id:i32, guild_commander_id:i32, edit_quest_model:EditQuestModel) -> Result<()>{
        unimplemented!()
    }
}