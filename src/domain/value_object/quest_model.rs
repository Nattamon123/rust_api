...
use crate::domain::{entites::quests::{AddQuestEntity, EditQuestEntity}, value_object::quest_statuses::QuestStatuses};
...
impl AddQuestModel {
    pub fn to_entity(&self,guild_commander_id:i32) -> AddQuestEntity{
        AddQuestEntity{
            ...
            guild_commander_id,
            status:crate::domain::value_object::quest_statuses::QuestStatuses::Open.to_string(), 
